...
- Every commit is [signed](https://github.com/abtion/guidelines/blob/main/setup/gpg_signing.md), [Co-authored](https://github.blog/2018-01-29-commit-together-with-co-authors/), and has passed the `pre-commit` hooks.
...
\* `main` might have a different name depending on the project. We strive to use an [inclusive language](https://github.com/abtion/guidelines/blob/main/behaviour_and_protocol/inclusive_language.md)
